...
def on_build_finished(app, exception):
    ...
    if not sys.modules.get("sphinxcontrib.mermaid"):
        ...
        extras in an isolated environment with:\n
            pipx install sphinx
            pipx inject sphinx sphinxcontrib-mermaid sphinx-book-theme\n
    ...
    if not sys.modules.get("sphinx_book_theme"):
        ...
        your Python venv. On Debian-based systems, you can install it with:\n
            sudo apt install python3-sphinx-book-theme\n
        Alternatively, you can use pipx to install sphinx and the needed
        extras in an isolated environment with:\n
            pipx install sphinx
            pipx inject sphinx sphinxcontrib-mermaid sphinx-book-theme\n
...
try:
    ...
    html_theme_options = {
       "announcement": "New: Design documentation for NUMA Claims in the Hypervisor Documentation!",
       "logo": {
    ...
    sys.stderr.write('Warning: sphinx_book_theme was not found, falling back to the default theme.\n')
