...
which indicates that the domain's claimed memory is specific to that NUMA node.
...
The following diagram illustrates the key functions and data structures involved
in the implementation of the XEN_DOMCTL_claim_memory:

.. mermaid:: DOMCTL_claim_memory-classes.mmd
  :caption: Diagram: Function and data relationships for XEN_DOMCTL_claim_memory
