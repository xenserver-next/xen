...
/*
 * Wrapper around xen/common/memory.c for the allocator test framework.
 *
 * The test framework includes the real memory.c directly in its translation
 ...
 */
#ifndef TOOLS_TESTS_ALLOC_MEMORY_PROXIES_H
#define TOOLS_TESTS_ALLOC_MEMORY_PROXIES_H
...
#endif /* TEST_WRAP_XEN_COMMON_MEMORY_C */
